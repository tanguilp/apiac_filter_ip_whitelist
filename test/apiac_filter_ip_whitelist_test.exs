defmodule APIacFilterIPWhitelistTest do
  use ExUnit.Case
  use Plug.Test
  doctest APIacFilterIPWhitelist

  test "valid IPv4 address" do
    opts = APIacFilterIPWhitelist.init(whitelist: ["221.92.0.0/16"])

    conn =
      conn(:get, "/")
      |> put_ip_address("221.92.173.24")
      |> APIacFilterIPWhitelist.call(opts)
  ...
  test "valid IPv6 address" do
    opts = APIacFilterIPWhitelist.init(whitelist: ["2001:F4E5:C0CA:4000::/50"])
  ...
  test "subnet list with valid address" do
    ...
    opts = APIacFilterIPWhitelist.init(whitelist: whitelist)
  ...
  test "valid IPv4 address with fun callback" do
    opts = APIacFilterIPWhitelist.init(whitelist: &my_cidr_list/1)
